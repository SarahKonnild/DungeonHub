...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.Character", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.CharacterClass", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.CharacterSkills", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.CharacterSubclass", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.Feature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.Character", b =>
                {
                    ...
                    b.HasOne("DungeonHub.Persistence.Models.Creature.Character.CharacterSkills", "CharacterSkills")
                        .WithMany()
                        .HasForeignKey("CharacterSkillsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DungeonHub.Persistence.Models.Creature.Character.CharacterClass", "Class")
                        .WithMany()
            ...
            modelBuilder.Entity("DungeonHub.Persistence.Models.Creature.Character.Feature", b =>
                {
                    ...
                    b.HasOne("DungeonHub.Persistence.Models.Creature.Character.CharacterSubclass", "Subclass")
                        .WithMany()
